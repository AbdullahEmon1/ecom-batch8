                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('brand.create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="firstName" name="name" placeholder="Enter Brand name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Brand Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="lastName" name="description" placeholder="Enter Brand Description"></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
