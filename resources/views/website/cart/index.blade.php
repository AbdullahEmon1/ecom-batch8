            ...
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <p>TK. {{round($product->subtotal)}}</p>
                        </div>
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" onclick="return confirm('Are you sure to delete this?')" href="{{route('cart.remove',['rowId' => $product->rowId])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax Amount(15%)@php($tax = round($sum*0.15))
                                            <span>Tk. {{$tax}}</span></li>
