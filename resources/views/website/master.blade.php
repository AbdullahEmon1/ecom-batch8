...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}website/assets/css/xzoom.css.css" />
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="quantity">{{$cartItem->qty}}x  <span class="amount">{{$cartItem->price}} = {{round($cartItem->subtotal)}}</span></p>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
