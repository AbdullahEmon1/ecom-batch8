                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            <img class="xzoom" height="400" width="400" id="xzoom-default" src="{{asset($product->image)}}" xoriginal="{{asset($product->image)}}"/>
                            <div class="xzoom-thumbs">
                                ...
                                @foreach($product->otherImages as $otherImage)
                                    <a href="{{asset($otherImage->image)}}"><img class="xzoom-gallery" height="80" width="80" src="{{asset($otherImage->image)}}" title="The description goes here"></a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                           ...
                           <form action="{{route('cart.add',['id' => $product->id])}}" method="POST">
                               @csrf
                            <div class="row">
                                <label class="col-md-4">Cart Product Quantity</label>
                                <div class="col-md-8">
                                    <input type="number" value="1" min="1" class="form-control" id="qty" name="qty">
                                </div>
                            </div>
