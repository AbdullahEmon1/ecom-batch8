                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="calendar2.html" class="slide-item">Add Courier</a></li>
                                <li><a href="chat.html" class="slide-item">Manage Courier</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="opacity.html" class="slide-item">Add User</a></li>
                                <li><a href="emptypage.html" class="slide-item">Manage User</a></li>
                            </ul>
                        </li>
                    </ul>
